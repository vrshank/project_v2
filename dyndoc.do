...
Information of the linked mortality can be found here:
https://ftp.cdc.gov/pub/HEALTH_STATISTICS/NCHS/datalinkage/linked_mortality/


**Methods:** 
This is a dataset from NHANES 1999-2000. We use the non-parametric and parametric methods to estimate the survival 
...
**Results:** 
The results are shown as figures 
The scenario is a specific case, so it should be interpreted with cautions (i.e., it may not be generalizable to other situations)

**Future Investigation:** 
Other confounders besides age and sex can be considered, such as race
